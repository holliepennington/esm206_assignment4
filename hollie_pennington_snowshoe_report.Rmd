...
```{r, include = FALSE}
#Attempted visualization, did not like graph, not including in knitted document but I worked really hard on this and dont want to delete it in case I need the reference later
